...
abstract class BaseGroupPeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(GroupPeer::CAPTAIN);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(GroupPeer::CAPTAIN,), array(UserPeer::ID,), $join_behavior);
    ...
    foreach (sfMixer::getCallables('BaseGroupPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseGroupPeer', $c, $con);
		...
		$c->addJoin(array(GroupPeer::CAPTAIN,), array(UserPeer::ID,), $join_behavior);
