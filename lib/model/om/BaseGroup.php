...
abstract class BaseGroup extends BaseObject  implements Persistent {
  ...
  const PEER = 'GroupPeer';
	...
	/**
	 * The value for the captain field.
	 * @var        int
	 */
	protected $captain;
	...
	/**
	 * Set the value of [captain] column.
	 * 
	 * @param      int $v new value
	 * @return     Group The current object (for fluent API support)
	 */
	public function setCaptain($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->captain !== $v) {
			$this->captain = $v;
			$this->modifiedColumns[] = GroupPeer::CAPTAIN;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->captain = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUser !== null && $this->captain !== $this->aUser->getId()) {
			$this->aUser = null;
		}
	} // ensureConsistency
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setCaptain($arr[$keys[2]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GroupPeer::CAPTAIN)) $criteria->add(GroupPeer::CAPTAIN, $this->captain);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setCaptain($this->captain);
	...
	{
		if ($this->aUser === null && ($this->captain !== null)) {
			$c = new Criteria(UserPeer::DATABASE_NAME);
			$c->add(UserPeer::ID, $this->captain);
	 ...
	 * related GroupUsers from storage. If this Group is new, it will return
		...
		if ($this->collGroupUsers === null) {
			if ($this->isNew()) {
			   $this->collGroupUsers = array();
				...
				$criteria->add(GroupUserPeer::GROUP_ID, $this->id);
	...
	public function getGroupUsersJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collGroupUsers === null) {
			if ($this->isNew()) {
				...
				$this->collGroupUsers = GroupUserPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
