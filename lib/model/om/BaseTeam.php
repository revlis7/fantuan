...
abstract class BaseTeam extends BaseObject  implements Persistent {
  ...
  const PEER = 'TeamPeer';
	...
	public function setCaptain($v)
	{
		...
		if ($this->captain !== $v) {
			$this->captain = $v;
			$this->modifiedColumns[] = TeamPeer::CAPTAIN;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = TeamPeer::STATUS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = TeamPeer::NUM_COLUMNS - TeamPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TeamPeer::CAPTAIN)) $criteria->add(TeamPeer::CAPTAIN, $this->captain);
		if ($this->isColumnModified(TeamPeer::STATUS)) $criteria->add(TeamPeer::STATUS, $this->status);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTeam:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTeam::%s', $method));
    }
