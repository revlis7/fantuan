...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Password', 'Name', 'Balance', 'Status', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'password', 'name', 'balance', 'status', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EMAIL, self::PASSWORD, self::NAME, self::BALANCE, self::STATUS, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'email', 'password', 'name', 'balance', 'status', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Password' => 2, 'Name' => 3, 'Balance' => 4, 'Status' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'password' => 2, 'name' => 3, 'balance' => 4, 'status' => 5, 'createdAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EMAIL => 1, self::PASSWORD => 2, self::NAME => 3, self::BALANCE => 4, self::STATUS => 5, self::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'email' => 1, 'password' => 2, 'name' => 3, 'balance' => 4, 'status' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
  ...
  {
    return array(array('email'), array('name'));
  }
	/**
