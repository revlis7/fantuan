...
abstract class BaseTeamPeer {
	...
	/** the column name for the CAPTAIN field */
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Captain', 'Status', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'captain', 'status', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::CAPTAIN, self::STATUS, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'captain', 'status', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Captain' => 2, 'Status' => 3, 'CreatedAt' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'captain' => 2, 'status' => 3, 'createdAt' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::CAPTAIN => 2, self::STATUS => 3, self::CREATED_AT => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'captain' => 2, 'status' => 3, 'created_at' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TeamPeer::CAPTAIN);

		$criteria->addSelectColumn(TeamPeer::STATUS);
    ...
    foreach (sfMixer::getCallables('BaseTeamPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseTeamPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseTeamPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseTeamPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseTeamPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseTeamPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseTeamPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseTeamPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseTeamPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseTeamPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseTeamPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseTeamPeer', $values, $con, $ret);
    }
